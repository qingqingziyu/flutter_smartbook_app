...
import 'AboutPandaPage.dart';

/**
 *@作者：陈飞
 *@说明：我的
 *@创建日期: 2019/8/22 13:54
 */
...
class _MePage extends State {
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      _childView(
                          "images/icon_me_account.png", "我的账户", "购买充值记录", true),
                      _childView(
                          "images/icon_me_task.png", "我的任务", "绑定手机送礼券", false),
                      _childView("images/icon_me_game.png", "我的游戏", "", true),
                      Container(
                        height: 12,
                        color: MyColors.dividerColor,
                      ),
                      _childView("images/icon_me_gift.png", "兑换中心", "", true),
                      _childView(
                          "images/icon_me_message.png", "我的消息", "88", false),
                      _childView("images/icon_me_comment.png", "我的评论",
                          "购买、充值记录", true),
                      Container(
                        height: 12,
                        color: MyColors.dividerColor,
                      ...
                      _childView(
                          "images/icon_me_cloud.png", "云书架", "同步书籍至云端", true),
                      _childView(
                          "images/icon_me_download.png", "我的下载", "", true),
                      _childView(
                          "images/icon_me_read_record.png", "最近阅读记录", "同步书籍至云端", true),
                      Container(
                        height: 12,
                        color: MyColors.dividerColor,
                      ),
                      _childView(
                          "images/icon_me_help.png", "帮助与反馈", "", true),
                      _childView(
                          "images/icon_me_panda.png", "关于Panda看书", "", true),
                      Container(
                        height: 50,
                        color: MyColors.dividerColor,
                      ),
   ...
   *@作者：陈飞
   *@说明：复用子View
   *@创建日期: 2019/8/22 14:22
   */
  Widget _childView(String image, String content, String massage, bool isGray) {
    return Material(
